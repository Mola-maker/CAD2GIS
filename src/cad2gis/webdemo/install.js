...
const transcript = [
  ...
  { at: 2210, kind: "command", text: "uv tool install --python 3.12 cad2gis[mcp,review]@git+…" },
  { at: 2590, kind: "info", text: "Fetching Python 3.12 · isolated tool environment" },
  { at: 3020, kind: "info", text: "Resolving GDAL · PROJ · Shapely · MCP · review UI" },
  { at: 3670, kind: "info", text: "Compiling cad2gis command entrypoints" },
  { at: 4210, kind: "muted", text: "Linked 84 packages · registered cad2gis-agent-mcp" },
  { at: 4770, kind: "success", text: "Installed cad2gis 0.2.0 with 2 executables" },
