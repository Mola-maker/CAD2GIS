...
且可导入的 `cad2gis_v3`、指向包含 `cad2gis_v3` 及其同级 reader 模块目录的
...
[`experiment/`](experiment/README.md) 保存 APD Hutabohu 的 reviewed legacy-schema
...
`experiment/py_scripts/convert_v3.py` 仅保留为委托到 `cad2gis.cli` 的兼容包装。
...
- [APD project pack 快速说明](experiment/README.md)
- [Architecture v3 详细设计](experiment/ARCHITECTURE_V3.md)
