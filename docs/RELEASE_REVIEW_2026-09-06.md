...
| Headless QGIS could render labels as boxes while the image was nonblank | Reject an empty font database; validate explicit font loading and record font families | Zero-font environment reproduced, then Arial render inspected with readable labels and 13 SVG features |
